...
class task_detail(LoginRequiredMixin, DetailView):
    ...
    # template_name = 'base.sdkjfhk.html" aby muc sie odwolywac za pomoca danej nazwy



class task_create(LoginRequiredMixin, CreateView):
    model = models.task
    fields = ['title', 'description', 'exp']
    success_url = reverse_lazy('task_list') # przekierowywuje do
